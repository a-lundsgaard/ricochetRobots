...
/// <param name="IsGameOver (method)">Checks if robot is on goal field.</param>
/// <param name="GetRobot (method)">Let the user choose a robot on the board via the console.</param>
/// <param name="RenderView (method)">Renders all board elements on the board and prints the board.</param>
/// <returns>Returns an object of the class when instantiated</returns>
